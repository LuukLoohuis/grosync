        ...
        const aiResponse = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
          ...
          body: JSON.stringify({
            ...
            messages: [
              {
                role: 'system',
                content: 'You extract recipe data from web page text. Return valid JSON only, no markdown code blocks. Schema: {"name":"string","description":"string","ingredients":["string"],"instructions":"string"}. For ingredients include quantities. For instructions write clear numbered steps. If no recipe found, return empty arrays/strings.'
              },
              {
                role: 'user',
